...
The Lord of the Bricks is a Java-based Arkanoid-style game inspired by the Lord of the Rings universe, 
built using simple 2D graphics and classic game mechanics.

This project was created during the Code for All_ Full Stack Bootcamp as a team challenge and later 
improved individually, focusing on clean code, object-oriented design, and game logic.
...
Built from scratch — no game engines, just Java fundamentals.
